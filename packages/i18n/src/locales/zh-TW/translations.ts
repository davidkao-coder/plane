...
export default {
  ...
  workspace: "工作區",
  archives: "封存",
  projects_overview: "專案總覽",
  projects_overview_page: {
    title: "專案總覽",
    description: "跨專案總覽所有任務進度",
    loading: "載入中…",
    no_data: "目前沒有資料",
    view_project: "專案",
    view_main_task: "主任務",
    view_sub_task: "子任務",
    member_loading: "成員 Loading 統計",
    col_member: "成員",
    col_total_issues: "任務總數",
    col_in_progress: "進行中",
    col_overdue: "逾期",
    col_estimate_hours: "預計工時",
    col_actual_hours: "實際工時",
    col_remaining_hours: "剩餘工時",
    col_task_rate: "任務完成率",
    col_hours_rate: "工時完成率",
    col_project_distribution: "跨專案分佈",
    block_no_date: "未排程",
    tooltip_tasks: "任務 {{done}}/{{total}}",
    tooltip_hours: "工時 {{done}}/{{total}} 小時",
    scale_week: "日",
    scale_month: "週",
    scale_quarter: "月",
    today: "今日",
  ...
  issue: {
    import: {
      title: "從 Excel 匯入任務",
      button: "匯入",
      select_file: "選擇 Excel 檔案（.xlsx）",
      drag_drop: "或拖曳至此處",
      file_hint: "僅支援 .xlsx 格式",
      preview_title: "預覽（共 {count} 筆任務）",
      parent_count: "{count} 個父任務",
      child_count: "{count} 個子任務",
      standalone_count: "{count} 個獨立任務",
      confirm: "確認匯入",
      importing: "匯入中...",
      result_title: "匯入完成",
      result_success: "成功建立 {count} 筆任務",
      result_warning: "{count} 筆有警告",
      ...
      column_state: "狀態",
      column_priority: "優先級",
      column_assignees: "指派成員",
      column_labels: "標籤",
      column_start_date: "開始日期",
      column_due_date: "截止日期",
      column_estimate_hours: "預計工時",
    ...
    export: {
      ...
      unstarted_issues: "未開始",
      cancelled_issues: "已取消",
      completion_rate: "完成率",
      estimate_hours: "預計工時",
      actual_hours: "實際工時",
      completed_hours: "已完成工時",
      remaining_hours: "剩餘工時",
      hours_completion_rate: "工時完成率",
      hours_variance: "工時偏差",
      risk_overdue: "逾期任務",
      risk_due_soon: "即將到期（7天內）",
