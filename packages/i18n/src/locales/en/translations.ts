...
export default {
  ...
  projects_overview_page: {
    title: "Projects Overview",
    description: "Cross-project overview of all task progress",
    loading: "Loading…",
    no_data: "No data available",
    view_project: "Projects",
    view_main_task: "Main tasks",
    view_sub_task: "Sub-tasks",
    member_loading: "Member Loading",
    col_member: "Member",
    col_total_issues: "Total issues",
    col_in_progress: "In progress",
    col_overdue: "Overdue",
    col_estimate_hours: "Estimate (hrs)",
    col_actual_hours: "Actual (hrs)",
    col_remaining_hours: "Remaining (hrs)",
    col_task_rate: "Task completion",
    col_hours_rate: "Hours completion",
    col_project_distribution: "Projects",
    block_no_date: "Unscheduled",
    tooltip_tasks: "Tasks {{done}}/{{total}}",
    tooltip_hours: "Hours {{done}}/{{total}}",
    scale_week: "Day",
    scale_month: "Week",
    scale_quarter: "Month",
    today: "Today",
    ...
    no_module: "(Ungrouped)",
    filter_modules: "Filter by category",
    clear: "Clear",
    no_modules: "No categories in this project",
  ...
  issue: {
    import: {
      ...
      file_hint: "Only .xlsx files are supported",
      preview_title: "Preview ({count} items to import)",
      parent_count: "{count} parent tasks",
      child_count: "{count} sub-tasks",
      standalone_count: "{count} standalone tasks",
      confirm: "Confirm Import",
      importing: "Importing...",
      result_title: "Import Complete",
      result_success: "Successfully created {count} tasks",
      result_warning: "{count} items with warnings",
    ...
    export: {
      ...
      section_hours: "Hours Statistics",
      section_risk: "Risk Management",
      section_members: "Member Hours",
      section_modules: "Module Progress",
      total_issues: "Total Issues",
      completed_issues: "Completed",
      in_progress_issues: "In Progress",
      unstarted_issues: "Not Started",
      ...
      hours_completion_rate: "Hours Completion Rate",
      hours_variance: "Hours Variance",
      risk_overdue: "Overdue",
      risk_due_soon: "Due Soon (7 days)",
      risk_high_priority: "High Priority Unfinished",
      member_name: "Member",
      issue_count: "Issues",
  ...
  workspace_analytics: {
    ...
    total_modules: "Total categories",
    pending_work_items: {
